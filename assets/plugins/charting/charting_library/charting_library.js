!(function (t, e) {
    ...
    let o = !1;
    function s() {
        return "CL v27.005 (internal id d37bee0 @ 2024-05-07T15:20:48.667Z)";
    }
    const r = class {
        constructor(t) {
            var i, s;
            if (((this._id = `tradingview_${((1048576 * (1 + Math.random())) | 0).toString(16).substring(1)}`), (this._ready = !1), (this._readyHandlers = []), (this._onWindowResize = this._autoResizeChart.bind(this)), !t.datafeed))
            ...
            (null === (i = t.overrides) || void 0 === i ? void 0 : i["mainSeriesProperties.priceAxisProperties.lockScale"]) &&
                (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"), delete t.overrides["mainSeriesProperties.priceAxisProperties.lockScale"]),
                (this._options = e(n, t));
            "dark" === (null !== (s = this._options.theme) && void 0 !== s ? s : "light").toLowerCase() && void 0 === this._options.loading_screen && (this._options.loading_screen = { backgroundColor: "#131722" }),
                this._options.debug && (o || ((o = !0), console.log("Using CL v27.005 (internal id d937bee0 @ 2024-05-07T15:20:48.667Z)"))),
                this._create();
        }
        setDebugMode(t) {
        ...
        _render(t) {
            ...
            if (
                ...
                (e[this._id].chartContent = { json: this._options.saved_data }), this._options.saved_data_meta_info && (e[this._id].chartContentExtendedData = this._options.saved_data_meta_info);
            ...
            const n = (function (t, e) {
                ...
                const o = new URL(`${t || ""}`, location.href).href,
                    s = JSON.parse(
                        '["bundles/runtime.1f6691a05496db116913.js","bundles/__LANG__.4716.e4ac74dfc9ec5374b00c.js","bundles/6150.bda60280b05cea478076.rtl.css","bundles/5142.2c34c8656148cc5203b7.js","bundles/library.53d7b371803f8096a4cd.js"]'
                    ),
            ...
            const s =
                ...
                (this._options.theme ? "&theme=" + encodeURIComponent(String(this._options.theme)) : "") +l
