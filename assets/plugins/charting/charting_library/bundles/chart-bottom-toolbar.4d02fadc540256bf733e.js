    ...
    [7260],
    {
        ...
        26996: (e, t, s) => {
            ...
            function o(e) {
                const { className: t, size: s = "medium", staticPosition: n, color: o = "black" } = e,
                    l = a(i().item, i()[o], i()[s]);
                return r.createElement("span", { className: a(i().loader, n && i().static, t) }, r.createElement("span", { className: l }), r.createElement("span", { className: l }), r.createElement("span", { className: l }));
            }
        },
        47201: (e, t, s) => {
            "use strict";
        ...
        51613: (e, t, s) => {
            ...
            function o(e) {
                ...
                return r.createElement("div", { className: n()(i.separator, "small" === t && i.small, "normal" === t && i.normal, "large" === t && i.large, s), role: "separator", "aria-hidden": a });
            }
        },
        40173: (e, t, s) => {
            "use strict";
        ...
        36898: (e, t, s) => {
            ...
            function i(e, t = !0) {
                (0, r.useEffect)(() => {
                    ...
                    const s = (t) => {
                        const s = e.current;
                        null !== s && document.activeElement instanceof HTMLElement && ((0, a.isKeyboardClick)(t) || (s.contains(document.activeElement) && "INPUT" !== document.activeElement.tagName && document.activeElement.blur()));
                    };
        ...
        88066: (e, t, s) => {
            ...
            const o = a.DEFAULT_TOOL_WIDGET_BUTTON_THEME,
                l = (0, r.forwardRef)(function (e, t) {
                    ...
                    return r.createElement(a.ToolWidgetButton, { "aria-label": i.PLATFORM_ACCESSIBILITY_ENABLED ? s : void 0, ...o, tag: i.PLATFORM_ACCESSIBILITY_ENABLED ? "button" : "div", ref: l, tabIndex: c, "data-tooltip": s });
                });
        },
        48889: (e, t, s) => {
            "use strict";
            ...
            const o = (0, r.forwardRef)(function (e, t) {
                ...
                return r.createElement(i.ToolWidgetIconButton, { "aria-label": n.PLATFORM_ACCESSIBILITY_ENABLED ? s : void 0, ...o, tag: n.PLATFORM_ACCESSIBILITY_ENABLED ? "button" : "div", ref: l, tabIndex: c, "data-tooltip": s });
            });
        },
        50298: (e, t, s) => {
            "use strict";
        ...
        33279: (e, t, s) => {
            ...
            function M(e) {
                const t = (function (e) {
                    ...
                    r = (function (e) {
                        ...
                        if (r.isWeeks()) return ((e) => n.t(null, { plural: "{str} weeks intervals", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(58667)))(r.multiplier());
                        if (r.isMonths()) {
                            const e = r.multiplier();
                            return e % 12 != 0
            ...
            function L(e) {
                ...
                return (
                    ((t = class extends r.PureComponent {
                        constructor(e, t) {
                            super(e, t),
                                ...
                                (this._handleSelectRange = (e) => {
                                    var t, s;
                                    (0, _.trackEvent)("GUI", "Chart Bottom Toolbar", `range ${e.value}`), null === (s = (t = this.props).onSelectRange) || void 0 === s || s.call(t, e), this._binding.selectRange(e);
                                }),
                        ...
                        render() {
                            return r.createElement(e, { goToDateButton: this.props.goToDateButton, className: this.props.className, ranges: this.state.ranges, activeRange: this.state.activeRange, onSelectRange: this._handleSelectRange });
                        }
                    }).contextType = I),
                    t
                );
            ...
            function U(e) {
                ...
                return r.createElement(
                    ...
                    r.createElement(N.ContextMenuItem, { icon: j, label: (0, W.appendEllipsis)(n.t(null, void 0, s(369))), onClick: t, active: !1, checked: !1, checkable: !1, disabled: !1, doNotCloseOnClick: !1, subItems: [] })
                );
            }
                ...
                constructor(e, t) {
                    super(e, t),
                        ...
                        (this._renderChildren = (e) => {
                            ...
                            return e
                                ? r.createElement(r.Fragment, null, r.createElement(H, { ranges: t, activeRange: s, onSelectRange: this._handleRangeSelect }), a && r.createElement(U, { onGoToDateClick: this._handleGoToDateClick }))
                                : r.createElement(
                                      r.Fragment,
                                      null,
                                      t.map((e) => r.createElement(p.AccessibleMenuItem, { key: e.value.value, label: e.description || e.text, isActive: s === e.value.value, onClick: this._handleRangeSelect, onClickArg: e })),
            ...
            class ue extends r.PureComponent {
                ...
                render() {
                    ...
                    return (
                        t.length > 0 && r.createElement(ie.ToolbarIconButton, { icon: oe, onClick: this._handleClick, "data-tooltip-hotkey": ce, tooltip: n.t(null, void 0, s(369)), "data-name": "go-to-date", className: o(le.button, e) })
                    );
                }
            }
            ue.contextType = de;
            ...
            class Xe extends r.PureComponent {
                ...
                _menuItems() {
                    ...
                    for (const n of t) {
                        ...
                        a.push(r.createElement(p.AccessibleMenuItem, { key: n.id, label: (0, Ue.translateSessionDescription)(n.description), isActive: this.state.sessionId === n.id, trackEventObject: t, onClick: i }));
                    }
                    return a;
                }
                _trackClick() {
            ...
            const rt = (0, ae.hotKeySerialize)({ keys: [(0, ne.humanReadableModifiers)(ne.Modifiers.Alt, !1), "Enter"], text: "{0} + {1}" }),
                ...
                it = { fullscreen: Number.MIN_SAFE_INTEGER, preventPhoneLayout: Number.MIN_SAFE_INTEGER, separator: -2, timeZones: -1, auto: 0, logarithm: 1, percentage: 2, session: 3, adj: 4, backAdj: 5, settlementAsClose: 6 },
                ot = (() => {
                    const e = new Map();
            ...
            const dt = { dateRangeMode: "hidden", separator: !0, timeZones: !0, fullscreen: !0, preventPhoneLayout: !0, auto: !0, logarithm: !0, percentage: !0, session: !0, adj: !0, backAdj: !0, settlementAsClose: !0 },
            ...
            class ht extends r.PureComponent {
                constructor(e, t) {
                    ...
                    super(e, t),
                            ...
                            (e, t, a) => {
                                if (r.isValidElement(e) && "string" != typeof e.type) {
                                    ...
                                    if ("string" == typeof i.className) {
                                        ...
                                        return r.createElement("div", { key: null === e.key ? void 0 : e.key, className: o(Ze.inline, c[d] && Ze.collapsed), ref: (e) => n(e, d), onClick: () => lt() }, r.cloneElement(e, l));
                                    }
                                }
                                return e;
                            })),
                        ...
                        (this._handleResize = () => {
                            null === this._raf &&
                                (this._raf = requestAnimationFrame(() => {
                                    ...
                                    } else Object.assign(e, { separator: !1, timeZones: !1, fullscreen: !1, preventPhoneLayout: !1, auto: !1, logarithm: !1, percentage: !1, session: !1, adj: !1, settlementAsClose: !1, backAdj: !1 });
                        ...
                        (0, b.validateRegistry)(t, { onContentBoxChanged: i.any.isRequired, chartApiInstance: i.any.isRequired, chartWidget: i.any.isRequired, chartWidgetCollection: i.any.isRequired, resizerDetacher: i.any.isRequired });
                    const { resizerDetacher: l } = this.context;
                    (this.state = { isFullscreenable: l.fullscreenable.value(), isPreventPhoneLayoutButton: this._isPreventPhoneLayoutButton() }), (this._resizeObserver = new ResizeObserver(this._handleMeasure));
                }
                componentDidMount() {
                ...
                render() {
                    const e = this._layout,
                        { timeFramesWidgetEnabled: t, timeWidgetEnabled: s, percentageScaleButtonEnabled: a, logScaleButtonEnabled: n, autoScaleButtonEnabled: i, fullscreenButtonEnabled: l } = this.props;
                    return r.createElement(
                        we.Toolbar,
                ...
                _applyResizing() {
                    ...
                    this._rangeExpanded && this._rangeExpanded.classList.toggle(Ze.collapsed, "expanded" !== e), this._rangeCollapsed && this._rangeCollapsed.classList.toggle(Ze.collapsed, "collapsed" !== e);
                    let s = !1,
                        r = !1;
            ...
            ht.contextType = ut;
            const mt = { onContentBoxChanged: i.any, computeContentBox: i.any, chartWidget: i.any, chartApiInstance: i.any, chartWidgetCollection: i.any, resizerDetacher: i.any, availableTimeFrames: i.any };
            class pt extends r.PureComponent {
                ...
                _defineRegistry(e) {
                    ...
                    this._registry = { onContentBoxChanged: t, computeContentBox: s, chartWidget: e, availableTimeFrames: o, chartApiInstance: r, chartWidgetCollection: a, resizerDetacher: e.getResizerDetacher() };
                }
            }
            class gt {
