...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/NicHolding/media/responsivefilemanager/source/',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'access_keys' => array('PrivateKey','gWgMQVkXcjpKgkcr'),
	...
	*/
	...
	'image_resizing_mode'                     => 'exact', // same as $image_max_mode
	...
	*/
	...
	'relative_image_creation_width'           => array( 0, 0 ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( 0, '' ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
