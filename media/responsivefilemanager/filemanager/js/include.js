...
!function (e, a, r) {
                ...
                callback: function () {
                    ...
                    if (null !== a) {
                        ...
                        e.ajax({
                            ...
                            data: {path: t, name: a, new_content: r}
                        }).done(function (e) {
    ...
    function i(a) {
        ...
        e.ajax({
            ...
            bootbox.dialog(t, [{label: jQuery("#cancel").val(), "class": "btn"}, {
                label: jQuery("#ok").val(),
                "class": "btn-inverse",
                callback: function () {
    ...
    function o(a) {
        ...
        var r = a.find(".rename-file-paths"), t = r.attr("data-path"), n = r.attr("data-permissions"),
            i = r.attr("data-folder");
        e.ajax({
            type: "POST",
            url: "ajax_calls.php?action=chmod",
            data: {path: t, permissions: n, folder: i}
        }).done(function (a) {
            bootbox.dialog(a, [{label: jQuery("#cancel").val(), "class": "btn"}, {
                label: jQuery("#ok").val(),
                "class": "btn-inverse",
                callback: function () {
                    ...
                    if ("" != n && "undefined" != typeof n) {
                        ...
                        "" != l && "undefined" != typeof l || (l = "none"), e.ajax({
                            ...
                            data: {path: t, new_mode: n, is_recursive: l, folder: i}
                        }).done(function (e) {
    ...
    function s() {
        bootbox.confirm(jQuery("#lang_clear_clipboard_confirm").val(), jQuery("#cancel").val(), jQuery("#ok").val(), function (a) {
            1 == a && e.ajax({type: "POST", url: "ajax_calls.php?action=clear_clipboard", data: {}}).done(function (e) {
    ...
    function p(a, r) {
        ...
        a.parent().hide(100), e.ajax({
            type: "POST",
            url: "ajax_calls.php?action=copy_cut",
            data: {path: n, sub_action: "cut"}
        }).done(function (t) {
            if ("" != t) bootbox.alert(t); else {
                var n;
    ...
    function v(e) {
        var r = jQuery(".breadcrumb").width() + e, t = jQuery("#view"), n = jQuery("#help");
    ...
    function j(e) {
        var a = new RegExp("(?:[?&]|&)" + e + "=([^&]+)", "i"), r = window.location.search.match(a);
    ...
    function b(a, r) {
        var t = jQuery("li.dir", "ul.grid").filter(":visible"), n = jQuery("li.file", "ul.grid").filter(":visible"),
            i = [], l = [], o = [], u = [];
        t.each(function () {
            var a = jQuery(this), t = a.find(r).val();
            if (e.isNumeric(t)) for (t = parseFloat(t); "undefined" != typeof i[t] && i[t];) t = parseFloat(parseFloat(t) + parseFloat(.001)); else t = t + "a" + a.find("h4 a").attr("data-file");
            i[t] = a.html(), l.push(t)
        }), n.each(function () {
            var a = jQuery(this), t = a.find(r).val();
            if (e.isNumeric(t)) for (t = parseFloat(t); "undefined" != typeof o[t] && o[t];) t = parseFloat(parseFloat(t) + parseFloat(.001)); else t = t + "a" + a.find("h4 a").attr("data-file");
            o[t] = a.html(), u.push(t)
    ...
    var k = "9.11.3", C = !0, T = 0, I = function () {
        var e = 0;
        return function (a, r) {
            clearTimeout(e), e = setTimeout(a, r)
        }
    }(), S = function (e) {
        if (1 == jQuery("#ftp").val()) var a = jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val(); else var a = jQuery("#base_url").val() + jQuery("#cur_dir").val();
        ...
        contextActions: {
            copy_url: function (e) {
                ...
                if (1 == jQuery("#ftp").val()) var r = jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a; else var r = jQuery("#base_url").val() + jQuery("#cur_dir").val() + a;
                ...
                var a, r = S(e), t = jQuery("#field_id").val(), n = jQuery("#return_relative_url").val();
                if (1 == n && (r = r.replace(jQuery("#base_url").val(), ""), r = r.replace(jQuery("#cur_dir").val(), "")), a = 1 == jQuery("#popup").val() ? window.opener : window.parent, "" != t) if (1 == jQuery("#crossdomain").val()) a.postMessage({
            ...
            e.contextMenu({
                ...
                build: function (e) {
                    ...
                    return (e.find(".img-precontainer-mini .filetype").hasClass("png") || e.find(".img-precontainer-mini .filetype").hasClass("jpg") || e.find(".img-precontainer-mini .filetype").hasClass("jpeg")) && r && (t.items.edit_img = {
                        ...
                        icon: "size",
                        disabled: !0
                    }), t.items.date = {name: e.find(".file-date").html(), icon: "date", disabled: !0}, t
                },
                events: {
                    hide: function () {
            ...
            r.on("click", ".modalAV", function (a) {
                var r = jQuery(this);
                a.preventDefault();
                var t = jQuery("#previewAV"), n = jQuery(".body-preview");
                ...
                a.preventDefault(), e.ajax({
                    url: r.attr("data-url"), success: function (e) {
                ...
                var a = jQuery(this), r = a.parent().parent().parent(), t = r.find("h4"), n = e.trim(t.text());
            ...
            jQuery("#filter-input").on("keyup", function () {
                ...
                jQuery(this).val(r), a && I(function () {
                    ...
                    }), e.ajax({url: "ajax_calls.php?action=filter&type=" + r}).done(function (e) {
                        "" != e && bootbox.alert(e)
                    }), I(function () {
            ...
            jQuery("#uploadURL").on("click", function (a) {
                a.preventDefault();
                var r = jQuery("#url").val(), t = jQuery("#cur_path").val(), n = jQuery("#cur_dir_thumb").val();
                show_animation(), e.ajax({
                    type: "POST",
                    url: "upload.php",
                    data: {path: t, path_thumb: n, url: r}
                }).done(function (e) {
            ...
            jQuery("input[name=radio-sort]").on("click", function () {
                var e = jQuery(this).attr("data-item"), t = jQuery("#" + e), n = jQuery(".filters label");
            ...
            jQuery(".sorter").on("click", function () {
                var t = jQuery(this);
                r = jQuery("#sort_by").val() !== t.attr("data-sort") || 0 == r, a ? (e.ajax({url: "ajax_calls.php?action=sort&sort_by=" + t.attr("data-sort") + "&descending=" + (r ? 1 : 0)}), b(r, "." + t.attr("data-sort")), jQuery(" a.sorter").removeClass("descending").removeClass("ascending"), r ? jQuery(".sort-" + t.attr("data-sort")).addClass("descending") : jQuery(".sort-" + t.attr("data-sort")).addClass("ascending"), jQuery("#sort_by").val(t.attr("data-sort")), jQuery("#descending").val(r ? 1 : 0), x()) : window.location.href = jQuery("#current_url").val() + "&sort_by=" + t.attr("data-sort") + "&descending=" + (r ? 1 : 0)
            })
        }
    };
    jQuery(document).ready(function () {
        ...
        }), U.bindGridEvents(), parseInt(jQuery("#file_number").val()) > parseInt(jQuery("#file_number_limit_js").val())) var o = !1; else var o = !0;
        if (U.makeSort(o), U.makeFilters(o), U.uploadURL(), jQuery("#info").on("click", function () {
            ...
            c.on("mouseover", function () {
                0 == jQuery("#view").val() && jQuery("#main-item-container").hasClass("no-effect-slide") === !1 && jQuery(this).find(".box:not(.no-effect)").animate({top: "-26px"}, {
                    queue: !1,
                    duration: 300
                })
        ...
        var n = jQuery("#callback").val(), i = jQuery("#cur_dir").val(), l = jQuery("#subdir").val(),
            o = jQuery("#base_url").val(), u = a.substr(0, a.lastIndexOf(".")), c = a.split(".").pop();
        c = c.toLowerCase();
        var s = "", d = ["ogg", "mp3", "wav"], f = ["mp4", "ogg", "webm"];
        if (1 == jQuery("#ftp").val()) var p = encodeURL(jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + a); else var y = jQuery("#return_relative_url").val(),
            p = encodeURL((1 == y ? l : o + i) + a);
        if ("" != r) if (1 == jQuery("#crossdomain").val()) t.postMessage({
            sender: "responsivefilemanager",
            url: p,
            field_id: r
        }, "*"); else {
        ...
        if (1 == jQuery("#popup").val()) var r = window.opener; else var r = window.parent;
        var t = jQuery("#callback").val(), n = jQuery("#cur_dir").val();
        n = n.replace("\\", "/");
        var i = jQuery("#subdir").val();
        i = i.replace("\\", "/");
        var l = jQuery("#base_url").val();
        if (1 == jQuery("#ftp").val()) var o = encodeURL(jQuery("#ftp_base_url").val() + jQuery("#upload_dir").val() + jQuery("#fldr_value").val() + e); else var u = jQuery("#return_relative_url").val(),
            o = encodeURL((1 == u ? i : l + n) + e);
        if ("" != a) if (1 == jQuery("#crossdomain").val()) r.postMessage({
            sender: "responsivefilemanager",
            url: o,
            field_id: a
        }, "*"); else {
        ...
        var n = t.find(".download-form"), i = "form" + (new Date).getTime();
        ...
        var t = e.find("a.link");
        r = t.attr("data-file");
        var n = r.substring(r.lastIndexOf("/") + 1), i = r.substring(r.lastIndexOf(".") + 1);
        t.each(function () {
        ...
        var o = e.find("a.rename-file"), u = e.find("a.delete-file"), c = o.attr("data-path"),
            s = c.replace(n, a + "." + i);
        ...
        e.find("h4 > a").text(a);
        var t = e.find(".folder-link"), n = t.attr("href"), i = jQuery("#fldr_value").val(),
            l = n.replace("fldr=" + i + encodeURIComponent(r), "fldr=" + i + encodeURIComponent(a));
        t.each(function () {
            jQuery(this).attr("href", l)
        });
        var o = e.find("a.delete-folder"), u = e.find("a.rename-folder"), c = u.attr("data-path"),
            s = c.lastIndexOf("/"), d = c.substr(0, s + 1) + a;
