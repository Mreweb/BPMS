...
<!--                        </a>-->
            ...
            <li>
                <a href="<?php echo base_url('Admin/Dashboard/Requests/legal'); ?>">
                    <div class="parent-icon"><i class="bx bx-category"></i></div>
                    <div class="menu-title">درخواست های مرحله حقوقی</div>
                </a>
            </li>
            <?php } ?>
            ...
            <li>
                <a href="<?php echo base_url('Admin/Dashboard/Requests/economic'); ?>">
                    <div class="parent-icon"><i class="bx bx-category"></i></div>
                    <div class="menu-title">درخواست های مرحله اقتصادی</div>
                </a>
            </li>
            <?php } ?>
            <?php if (getLoginRoles()[0] == 'ADMIN' || getLoginRoles()[0] == 'MANAGER' ) { ?>
            <li>
                <a href="<?php echo base_url('Admin/Dashboard/Requests/final'); ?>">
                    <div class="parent-icon"><i class="bx bx-category"></i></div>
                    <div class="menu-title">درخواست های مرحله نهایی</div>
                </a>
            </li>
            <li>
...
<!--                                                <img src="--><?php //echo $_DIR; ?><!--/assets/images/avatars/avatar-1.png"-->
<!--                                                     class="msg-avatar"-->
<!--                                                     alt="توضیح تصویر">-->
<!--                                            </div>-->
...
<!--                                        <div class="d-flex align-items-center">-->
<!--                                            <div class="user-online">-->
<!--                                                <img src="--><?php //echo $_DIR; ?><!--/assets/images/avatars/avatar-2.png"-->
<!--                                                     class="msg-avatar"-->
<!--                                                     alt="توضیح تصویر">-->
<!--                                            </div>-->
<!--                                            <div class="flex-grow-1">-->
...
<!--                                                <img src="--><?php //echo $_DIR; ?><!--/assets/images/app/outlook.png" width="25"-->
<!--                                                     alt="توضیح تصویر">-->
<!--                                            </div>-->
<!--                                            <div class="flex-grow-1">-->
...
<!--                                        <div class="d-flex align-items-center">-->
<!--                                            <div class="user-online">-->
<!--                                                <img src="--><?php //echo $_DIR; ?><!--/assets/images/avatars/avatar-4.png"-->
<!--                                                     class="msg-avatar"-->
<!--                                                     alt="توضیح تصویر">-->
<!--                                            </div>-->
<!--                                            <div class="flex-grow-1">-->
...
<!--                                                <img src="--><?php //echo $_DIR; ?><!--/assets/images/app/github.png" width="25"-->
<!--                                                     alt="توضیح تصویر">-->
<!--                                            </div>-->
<!--                                            <div class="flex-grow-1">-->
...
<!--                                        <div class="d-flex align-items-center">-->
<!--                                            <div class="user-online">-->
<!--                                                <img src="--><?php //echo $_DIR; ?><!--/assets/images/avatars/avatar-8.png"-->
<!--                                                     class="msg-avatar"-->
<!--                                                     alt="توضیح تصویر">-->
<!--                                            </div>-->
<!--                                            <div class="flex-grow-1">-->
