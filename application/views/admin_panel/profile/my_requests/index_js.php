<script type="text/javascript">
    $(document).ready(function () {
        ...
        function loadData(selectedPage = $selectedPage) {
            toggleLoader();
            $sendData = {
                /*'inputPersonFirstName': $("#inputPersonFirstName").val(),
                'inputPersonLastName': $("#inputPersonLastName").val(),
                'inputPersonNationalCode': $("#inputPersonNationalCode").val(),
                'inputPersonPhone': $("#inputPersonPhone").val(),*/
                'pageIndex': selectedPage
            }
            $.ajax({
                type: 'post',
                url: base_url + 'Profile/doMyRequestsPagination',
                data: $sendData,
