...
<div class="page-wrapper">
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Admin/Dashboard/Home'); ?>"><i class="bx bx-home-alt"></i></a>
                        </li>
        ...
        <h6 class="mb-0 text-uppercase">فهرست کاربران</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
...
<!--                        <label class="col-sm-12 col-md-2 mb-3">-->
<!--                            کد ملی:-->
<!--                            <input type="search" class="form-control form-control-sm" id="inputPersonNationalCode"/>-->
<!--                        </label>-->
<!--                        <label class="col-sm-12 col-md-2 mb-3">-->
<!--                            تلفن:-->
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="fit">پکیج فعال</th>
                            <th>کلاس</th>
                            <th class="fit">متد</th>
                            <th class="fit">آی پی</th>
                            <th class="fit">پلتفرم</th>
                            <th class="fit">تاریخ ثبت</th>
                            <th class="fit">ساعت ثبت</th>
                        </tr>
                        </thead>
