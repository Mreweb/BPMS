                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="p-4">
                                ...
                                <div class="form-body">
                                    <form class="row g-3">
                                        <div class="col-12 col-md-6 phone">
                                            <label for="inputFirstName" class="form-label">نام نماینده</label>
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control ltr" placeholder="نام خود را وارد کنید" id="inputFirstName" />
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 phone">
                                            <label for="inputLastName" class="form-label">نام خانوادگی نماینده</label>
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control ltr" placeholder="نام خانوادگی خود را وارد کنید" id="inputLastName" />
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 phone">
                                        ...
                                        <div class="col-12 col-md-6 phone">
                                            <label for="inputLegalCompanyCode" class="form-label">شناسه ملی شرکت</label>
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control text-end ltr" placeholder="شناسه ملی شرکت را وارد کنید" id="inputLegalCompanyCode" />
                                            </div>
                                        </div>
                                ...
                                <div class="login-separater text-center mb-5"> <span>یا از طریق نام کاربری وارد شوید</span>
                                    <hr/>
                                </div>
