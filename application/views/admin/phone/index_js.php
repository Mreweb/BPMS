<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#login").click(function (e) {
            ...
            $inputLegalCompanyCode  = $("#inputLegalCompanyCode").val();
            $inputCaptcha = $("#inputCaptcha").val();
            if ( $inputPhone != "" && $inputLegalCompanyCode != "" &&  $inputFirstName != "" && $inputLastName != "" && $inputCaptcha != "") {
                $sendData = {
                ...
                $.ajax({
                    type: 'post',
                    url: base_url + 'Account/do_submit_phone',
                    data: $sendData,
